...
[role="lead"]
La documentazione è disponibile anche per le versioni precedenti alla versione 5,3 del plug-in NetApp Element per VMware vCenter Server.


NOTE: Questo link:index.html["link alla documentazione"] Per Element vCenter, il plug-in 5,3 include anche le versioni 5,2, 5,1, 5,0, 4,10, 4,9, 4,8, 4,7 e 4,6.
