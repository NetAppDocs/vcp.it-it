...
* https://library.netapp.com/ecm/ecm_download_file/ECMLP3362264["Note sulla versione NetApp Element Software 12.9"^]_Nuovo_
* https://library.netapp.com/ecm/ecm_download_file/ECMLP2886996["Note sulla versione del software NetApp Element 12,8"^]
...
* https://library.netapp.com/ecm/ecm_download_file/ECMLP3344864["Note sulla versione del plug-in vCenter 5.5"^]
