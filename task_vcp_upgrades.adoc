...
[role="lead"]
È possibile aggiornare il plug-in NetApp Element per vCenter Server seguendo la procedura descritta per l'installazione. Il plug-in NetApp Element vCenter 5.1 è disponibile al di fuori delle release Element e NetApp HCI come parte di un bundle di servizi di gestione.
